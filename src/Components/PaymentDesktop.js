        ...
        <div style={{marginBottom: '100px'}}>
            ...
            {localStorage.screenSize > 950 ? (
                ...
                <div style={{
                    ...
                    <div style={{height: '1px', width: '60%', 
                    background: 'rgba(255, 255, 255, 0.75)', 
                    marginLeft: 'auto', marginRight: 'auto', marginTop: '50%', 
                    position: 'absolute',  justifyContent: 'center', left: '20%'
                    ...
                    {/* line devider */}
                                ...
                                background: 'rgba(173, 221, 226, 0.25)',
                                WebkitBackdropFilter: 'blur(10px)',
                                borderRadius: '10px', marginTop: '32px', marginLeft: 'auto', marginRight: 'auto'
                                }}>
                                    <p
                                    style={{
                                        width: '180px', textAlign: 'center', fontSize: '14px',
                                ...
                                <p
                                    style={{
                                        width: '180px', textAlign: 'center', fontSize: '14px',
                                        marginLeft: 'auto', marginRight: 'auto', paddingTop: '8px', 
                                        marginBottom: '0px', marginTop: '24px'
                                    }}
                                    >
                                        {sub1}
                                </p>
                                ...
                                <p
                                    style={{
                                        width: '210px', textAlign: 'center', fontSize: '14px',
                                        marginLeft: 'auto', marginRight: 'auto', paddingTop: '8px', 
                                        marginBottom: '0px', marginTop: '48px'
                                    }}
                                    >
                                        {sub2}
                                    </p>

        ...
        <div>
            ...
            <h2 className='oswald'
                ...
                <div style={{
                    ...
                    {/* Element1 */}
                    <QualityElement name={name1} text={text1}/>

                    {/* Feature2 */}
                    <QualityElement name={name2} text={text2}/>

                    {/* Feature3 */}
                    <QualityElement name={name3} text={text3}/>
                ...
                <div style={{
                    ...
                    {/* Element1 */}
                    <QualityElement name={name4} text={text4}/>

                    {/* Feature2 */}
                    <QualityElement name={name5} text={text5}/>

                    {/* Feature3 */}
                    <QualityElement name={name6} text={text6}/>

                    {/* Feature4 */}
                    <QualityElement name={name7} text={text7}/>
